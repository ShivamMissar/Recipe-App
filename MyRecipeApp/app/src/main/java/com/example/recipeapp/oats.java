...
public class oats extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        step1 = findViewById(R.id.OTstep_1);
        step2 = findViewById(R.id.OTstep_2);
        ...
        addToFav.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                firebaseFirestore.collection("AllRecipes").document("Oats").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
