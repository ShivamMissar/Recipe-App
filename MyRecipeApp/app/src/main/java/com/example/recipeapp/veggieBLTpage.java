...
public class veggieBLTpage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_veggie_bltpage);

        step1 = findViewById(R.id.BLTstep_1);
        step2 = findViewById(R.id.BLTstep_2);
        ...
        add_To_Fav.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                firebaseFirestore.collection("AllRecipes").document("VeggieBLT").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
