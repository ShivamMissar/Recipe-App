...
public class tomatoRissitoPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tomato_rissito_page);
        step1 = findViewById(R.id.TRstep_1);
        step2 = findViewById(R.id.TRstep_2);
        ...
        add_To_Fav.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                firebaseFirestore.collection("AllRecipes").document("Tomato Risotto").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
