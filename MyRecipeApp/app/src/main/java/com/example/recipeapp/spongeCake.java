...
public class spongeCake extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        step1 = findViewById(R.id.ETSstep_1);
        step2 = findViewById(R.id.ETSstep_2);
        ...
        addToFav.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                firebaseFirestore.collection("AllRecipes").document("EasyTreacleSponge").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
