...
public class ramenNoodlesPage extends AppCompatActivity {

    private Button got_The_Required_Ingr;
    private FirebaseUser user;
    private CheckBox add_To_Fav;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ramen_noodles_page);


        step1 = findViewById(R.id.VRNstep_1);
        step2 = findViewById(R.id.VRNstep_2);
        step3 = findViewById(R.id.VRNstep_3);
        ...
        add_To_Fav.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                firebaseFirestore.collection("AllRecipes").document("VeggieRamenNoodles").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
