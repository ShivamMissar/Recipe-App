...
public class salmonSalad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salmon_salad);
        step1 = findViewById(R.id.SSstep_1);
        step2 = findViewById(R.id.SSstep_2);
        ...
        addToFav.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                firebaseFirestore.collection("AllRecipes").document("SalmonSalad").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
