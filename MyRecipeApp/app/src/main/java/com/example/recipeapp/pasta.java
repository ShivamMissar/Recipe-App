...
public class pasta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        step1 = findViewById(R.id.CPstep_1);
        step2 = findViewById(R.id.CPstep_2);
        step3 = findViewById(R.id.CPstep_3);
        step4 = findViewById(R.id.CPstep_4);
        ...
        add_To_Fav.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                firebaseFirestore.collection("AllRecipes").document("CreamyPasta").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
