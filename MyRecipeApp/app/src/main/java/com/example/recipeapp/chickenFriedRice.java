...
public class chickenFriedRice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chicken_fried_rice);
        step1 = findViewById(R.id.ck_step_1);
        step2 = findViewById(R.id.ck_step_2);
        step3 = findViewById(R.id.ck_step_3);
        ...
        addToFav.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                firebaseFirestore.collection("AllRecipes").document("ChickenFriedRice").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
