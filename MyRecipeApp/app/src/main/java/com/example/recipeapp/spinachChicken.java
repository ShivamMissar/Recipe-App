...
public class spinachChicken extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spinach_chicken);


        got_the_required_ingr = findViewById(R.id.checkedForRequiredItems);
        step1 = findViewById(R.id.SCstep_1);
        step2 = findViewById(R.id.SCstep_2);
        ...
        addToFav.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                firebaseFirestore.collection("AllRecipes").document("SpinachChicken").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
