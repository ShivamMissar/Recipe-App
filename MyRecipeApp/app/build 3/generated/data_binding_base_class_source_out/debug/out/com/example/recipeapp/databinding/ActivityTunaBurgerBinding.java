...
public final class ActivityTunaBurgerBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView TBstep1;

  @NonNull
  public final TextView TBstep2;

  @NonNull
  public final TextView TunaBurgerTitle;

  @NonNull
  public final Button checkedForRequiredItems;

  @NonNull
  public final TextView difficultyLevel14;
  ...
  @NonNull
  public final TextView totaltime14;

  private ActivityTunaBurgerBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView ChickenRiceSoupDesc, @NonNull CheckBox FavouritesCheck,
      @NonNull TextView RequiredList, @NonNull TextView TBstep1, @NonNull TextView TBstep2,
      @NonNull TextView TunaBurgerTitle, @NonNull Button checkedForRequiredItems,
      @NonNull TextView difficultyLevel14, @NonNull ImageView imageView6,
      ...
      @NonNull TextView requiredItem7, @NonNull TextView requireditem4,
      @NonNull TextView requireditem5, @NonNull TextView totaltime14) {
    this.rootView = rootView;
    this.ChickenRiceSoupDesc = ChickenRiceSoupDesc;
    this.FavouritesCheck = FavouritesCheck;
    this.RequiredList = RequiredList;
    this.TBstep1 = TBstep1;
    this.TBstep2 = TBstep2;
    this.TunaBurgerTitle = TunaBurgerTitle;
    this.checkedForRequiredItems = checkedForRequiredItems;
    this.difficultyLevel14 = difficultyLevel14;
  ...
  @NonNull
  public static ActivityTunaBurgerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTunaBurgerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_tuna_burger, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTunaBurgerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.TBstep_1;
      TextView TBstep1 = ViewBindings.findChildViewById(rootView, id);
      if (TBstep1 == null) {
        break missingId;
      }

      id = R.id.TBstep_2;
      TextView TBstep2 = ViewBindings.findChildViewById(rootView, id);
      if (TBstep2 == null) {
        break missingId;
      }

      id = R.id.TunaBurgerTitle;
      TextView TunaBurgerTitle = ViewBindings.findChildViewById(rootView, id);
      if (TunaBurgerTitle == null) {
        break missingId;
      }
      ...
      id = R.id.difficultyLevel14;
      TextView difficultyLevel14 = ViewBindings.findChildViewById(rootView, id);
      if (difficultyLevel14 == null) {
        break missingId;
      }
      ...
      id = R.id.totaltime14;
      TextView totaltime14 = ViewBindings.findChildViewById(rootView, id);
      if (totaltime14 == null) {
        break missingId;
      }

      return new ActivityTunaBurgerBinding((ConstraintLayout) rootView, ChickenRiceSoupDesc,
          FavouritesCheck, RequiredList, TBstep1, TBstep2, TunaBurgerTitle, checkedForRequiredItems,
          difficultyLevel14, imageView6, requiredItem1, requiredItem2, requiredItem3, requiredItem6,
          requiredItem7, requireditem4, requireditem5, totaltime14);
    }
