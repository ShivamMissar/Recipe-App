...
public final class SingleListItemBinding implements ViewBinding {
  @NonNull
  ...
  private SingleListItemBinding(@NonNull CardView rootView, @NonNull Button delete,
  ...
  @NonNull
  public static SingleListItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  @NonNull
  public static SingleListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SingleListItemBinding((CardView) rootView, delete, recipeImage, recipeName);
    }
