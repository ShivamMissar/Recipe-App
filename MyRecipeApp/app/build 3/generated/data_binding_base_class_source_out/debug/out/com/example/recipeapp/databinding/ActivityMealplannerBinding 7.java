...
public final class ActivityMealplannerBinding implements ViewBinding {
  ...
  @NonNull
  public final BottomNavigationView mealBottomNav;
  ...
  private ActivityMealplannerBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull EditText location, @NonNull BottomNavigationView mealBottomNav,
      @NonNull EditText notes, @NonNull RelativeLayout relativeLayout,
    ...
    this.mealBottomNav = mealBottomNav;
    this.notes = notes;
  ...
  public static ActivityMealplannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.mealBottomNav;
      BottomNavigationView mealBottomNav = ViewBindings.findChildViewById(rootView, id);
      if (mealBottomNav == null) {
        break missingId;
      }
      ...
      return new ActivityMealplannerBinding((ConstraintLayout) rootView, CreateEvent, RecipeNames,
          calander, location, mealBottomNav, notes, relativeLayout, textView2);
    }
