...
public final class ActivitySpongeCakeBinding implements ViewBinding {
  ...
  private ActivitySpongeCakeBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView Method, @NonNull TextView RequiredList, @NonNull TextView SpongeCakeTitle,
  ...
  public static ActivitySpongeCakeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySpongeCakeBinding((ConstraintLayout) rootView, ChickenRiceSoupDesc,
          FavouritesCheck, Method, RequiredList, SpongeCakeTitle, checkedForRequiredItems,
          imageView6, requiredItem1, requiredItem2, requiredItem3, requiredItem6, requiredItem7,
          requiredItem8, requireditem4, requireditem5);
    }
